...
public class CO_pocket_cards_black_fold extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_co_pocket_cards_black_fold);
    }
    ...
    public void onBack(View v){
        startActivity(new Intent(getApplicationContext(), CO_pocket_cards_black.class));
    }
}
