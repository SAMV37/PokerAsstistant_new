...
public class BB_pocket_cards_red extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bb_pocket_cards_red);
    }
    ...
    public void onCall(View v){
        startActivity(new Intent(getApplicationContext(), BB_pocket_cards_red_call.class));
    }
