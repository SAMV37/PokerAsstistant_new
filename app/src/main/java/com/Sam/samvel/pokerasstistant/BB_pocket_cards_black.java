...
public class BB_pocket_cards_black extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bb_pocket_cards_black);
    }
    ...
    public void onCall(View v){
        startActivity(new Intent(getApplicationContext(), BB_pocket_cards_black_call.class));
    }
