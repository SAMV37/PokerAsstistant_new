...
public class SB_pocket_cards_red_call extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sb_pocket_cards_red_call);
    }
    ...
    public void onBack(View v){
        startActivity(new Intent(getApplicationContext(), SB_pocket_cards_red.class));
    }
}
